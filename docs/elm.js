...
var _user$project$State$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'NextProblem') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{selectedProblem: _p0._0._0, otherProblems: _p0._0._1, guess: _elm_lang$core$Maybe$Nothing}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
			return _elm_lang$core$Native_Utils.eq(model.guess, _elm_lang$core$Maybe$Nothing) ? {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
