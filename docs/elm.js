...
var _andrewMacmurray$elm_delay$Delay$getDelay = F2(
	function (n, msgs) {
		return A2(
			...
			A2(
				...
				_elm_lang$core$List$head(
					A2(_elm_lang$core$List$drop, n, msgs))));
	});
var _andrewMacmurray$elm_delay$Delay$after = F2(
	function (ms, msg) {
		return A2(
			_elm_lang$core$Task$perform,
			...
			A2(
				...
				_elm_lang$core$Process$sleep(_elm_lang$core$Time$millisecond * ms)));
	});
var _andrewMacmurray$elm_delay$Delay$startIf = F3(
	function (predicate, sequenceMsg, msgs) {
		if (predicate) {
			var firstDelay = A2(_andrewMacmurray$elm_delay$Delay$getDelay, 0, msgs);
			return A2(
...
var _andrewMacmurray$elm_delay$Delay$start = F2(
	function (sequenceMsg, msgs) {
		return A3(_andrewMacmurray$elm_delay$Delay$startIf, true, sequenceMsg, msgs);
	});
var _andrewMacmurray$elm_delay$Delay$handleSequence = F4(
	function (sequenceMsg, msgs, update, model) {
		var _p0 = _elm_lang$core$List$head(msgs);
		if (_p0.ctor === 'Just') {
			var _p1 = A2(update, _p0._0._1, model);
			var newModel = _p1._0;
			var cmd = _p1._1;
			var nextDelay = A2(_andrewMacmurray$elm_delay$Delay$getDelay, 1, msgs);
			var remainingMsgs = A2(_elm_lang$core$List$drop, 1, msgs);
			var nextCmd = (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$List$length(msgs),
				1) > 0) ? A2(
				_andrewMacmurray$elm_delay$Delay$after,
				nextDelay,
				sequenceMsg(remainingMsgs)) : _elm_lang$core$Platform_Cmd$none;
			return A2(
...
var _user$project$Views$reallyBig = function (str) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('really-big'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Views$cardView = F2(
	function (cardContents, cardActions) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('card blue-grey darken-1'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Views$wrapRow = function (nodes) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Views$wrapColumn4 = function (html) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Views$buttonView = function (button) {
	var classValue = button.markCorrect ? 'waves-effect waves-light btn green' : (button.markIncorrect ? 'waves-effect waves-light btn red' : (button.markRealAnswer ? 'waves-effect waves-light btn green pulse' : 'waves-effect waves-light btn blue'));
	return _user$project$Views$wrapColumn4(
		A2(
			_elm_lang$html$Html$a,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(classValue),
				_1: {
					ctor: '::',
...
var _user$project$Views$buttonRowView = function (buttons) {
	return _user$project$Views$wrapRow(
		A2(_elm_lang$core$List$map, _user$project$Views$buttonView, buttons));
};
var _user$project$Views$wrapColumn12 = function (html) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Views$numberCardView = function (card) {
	return _user$project$Views$wrapColumn12(
		A2(
			_user$project$Views$cardView,
			{
				ctor: '::',
				_0: _user$project$Views$reallyBig(card.question),
				_1: {ctor: '[]'}
			},
...
var _user$project$State$generateNext = function (model) {
	return A2(
		_elm_lang$core$Random$generate,
		_user$project$Types$NextProblem,
		_elm_community$random_extra$Random_List$choose(model.otherProblems));
};
var _user$project$State$init = function () {
	...
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: _user$project$State$generateNext(model)
	};
}();
var _user$project$State$correctGuess = function (model) {
	return (!_elm_lang$core$Native_Utils.eq(model.guess, _elm_lang$core$Maybe$Nothing)) && _elm_lang$core$Native_Utils.eq(
		model.guess,
		A2(
			_elm_lang$core$Maybe$map,
			function (_) {
...
var _user$project$State$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'NextProblem':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							selectedProblem: _p0._0._0,
							otherProblems: A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_community$maybe_extra$Maybe_Extra$toList(model.selectedProblem),
								_p0._0._1),
							guess: _elm_lang$core$Maybe$Nothing
						}),
			...
			default:
				if (_elm_lang$core$Native_Utils.eq(model.guess, _elm_lang$core$Maybe$Nothing)) {
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{
							guess: _elm_lang$core$Maybe$Just(_p0._0)
						});
					var delayTime = _user$project$State$correctGuess(newModel) ? 100 : 2000;
					return {
						ctor: '_Tuple2',
						_0: newModel,
						_1: A2(_andrewMacmurray$elm_delay$Delay$after, delayTime, _user$project$Types$PickNew)
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$State$init, view: _user$project$Views$view, update: _user$project$State$update, subscriptions: _user$project$State$subscriptions})();
