...
var _user$project$Types$Model = F2(
	function (a, b) {
		return {selectedProblem: a, otherProblems: b};
	});
...
var _user$project$Views$cardView = F2(
	function (cardContent, cardAction) {
		return A2(
...
var _user$project$Views$wrapColumn = function (html) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Views$numberCardView = function (card) {
	return _user$project$Views$wrapColumn(
		A2(
			_user$project$Views$cardView,
			_user$project$Views$reallyBig(card.question),
			_user$project$Views$noChildNodes));
};
var _user$project$Views$button = F2(
	function (answer, numeral) {
		return {
			numeral: numeral,
			isCorrect: _elm_lang$core$Native_Utils.eq(answer, numeral)
		};
	});
var _user$project$Views$numberCard = function (numberProblem) {
	return {
		...
		buttonRows: {
			...
			_0: A2(
				_elm_lang$core$List$map,
				_user$project$Views$button(numberProblem.numeral),
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '::',
							_0: A2(_user$project$Views$button, numberProblem.numeral, 10),
							_1: {ctor: '[]'}
						},
						_1: {ctor: '[]'}
					}
...
var _user$project$Views$view = function (model) {
	...
	if (_p0.ctor === 'Just') {
		return _user$project$Views$numberCardView(
			_user$project$Views$numberCard(_p0._0));
	} else {
		return _user$project$Views$numberCardView(
			{
				question: 'Loading...',
